 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/entity/JobProject.java
 *
 *-------------------------------------------------------------------------
 */
@Data
@TableName("job_project")
public class JobProject {
    ...
    @ApiModelProperty("运行状态: 0 未启动,1 运行中, 2 异常终止, 3 已完成")
    private int runningStatus;

    @ApiModelProperty("调度状态: 0 停止, 1 启动")
    private int triggerStatus;

    @ApiModelProperty("日志文件存放路径")
    ...
    @ApiModelProperty("源端需要迁移的schema")
