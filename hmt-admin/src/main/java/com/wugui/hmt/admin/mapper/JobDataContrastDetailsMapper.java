...
/*-------------------------------------------------------------------------
 *
 * JobDataContrastDetailsMapper.java
 *   
 * 
 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/mapper/JobDataContrastDetailsMapper.java
 *
 *-------------------------------------------------------------------------
 */
@Mapper
@Repository
public interface JobDataContrastDetailsMapper {

    int save(JobDataContrastDetails jobDataContrastDetails);

    int update(JobDataContrastDetails jobDataContrastDetails);

    List<JobDataContrastDetails> pageList(@Param("offset") int offset,
                                @Param("pagesize") int pagesize,
                                @Param("taskId") int taskId,
                                @Param("tableName") String tableName,
                                @Param("isCorrect") int isCorrect,
                                @Param("fastQue") int fastQue,
    ...
    JobDataContrastDetails getInfoById(@Param("id") int id);

    Map<String, Object> detailsCount(@Param("taskId") int taskId, @Param("metaTypeId") String metaTypeId);
