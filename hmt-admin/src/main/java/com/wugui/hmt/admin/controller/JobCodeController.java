...
import com.wugui.hmt.admin.entity.JobLogGlue;
import com.wugui.hmt.admin.mapper.JobInfoMapper;
import com.wugui.hmt.admin.mapper.JobLogGlueMapper;
 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/controller/JobCodeController.java
 *
 *-------------------------------------------------------------------------
 */
@RestController
