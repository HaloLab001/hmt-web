 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/mapper/KafkaSyncMapper.java
 *
 *-------------------------------------------------------------------------
 */
@Mapper
@Repository
public interface KafkaSyncMapper {

    int save(JobKafkaSync kafkaSync);

    int update(JobKafkaSync kafkaSync);

    List<JobKafkaSync> pageList(@Param("offset") int offset,
    ...
    JobKafkaSync getInfoById(@Param("id") int id);

    List<JobKafkaSync> getTaskList(@Param("taskName") String taskName,
                                @Param("projectIds") Integer[] projectIds);

    int batchDeleteTask(@Param("taskName") String taskName,
                        @Param("projectIds") Integer[] projectIds);
