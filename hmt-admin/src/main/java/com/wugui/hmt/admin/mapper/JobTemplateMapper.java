 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/mapper/JobTemplateMapper.java
 *
 *-------------------------------------------------------------------------
 */
@Mapper
public interface JobTemplateMapper {
	...
	int deleteTemplateByProjectId(@Param("projectId") Long projectId);

	public JobTemplate loadByProjectId(@Param("projectId") int projectId);
