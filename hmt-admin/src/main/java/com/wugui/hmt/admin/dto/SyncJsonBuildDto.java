package com.wugui.hmt.admin.dto;
 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/dto/SyncJsonBuildDto.java
 *
 *-------------------------------------------------------------------------
 */
@Data
public class SyncJsonBuildDto implements Serializable {
    ...
    // 源端数据源id
    private int readerDatasourceId;
    ...
    private String reKeyColumns;

    // 目标端数据源id
    private int writerDatasourceId;
    ...
    // 目标端Json
    private String writerJson;

    // 源端表名集合(仅在批量使用)
    private String[] readerTables;
