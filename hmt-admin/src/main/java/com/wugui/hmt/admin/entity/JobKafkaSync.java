 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/entity/JobKafkaSync.java
 *
 *-------------------------------------------------------------------------
 */
@Data
public class JobKafkaSync {
    ...
    @ApiModelProperty("同步Json")
    private String syncJson;

    @ApiModelProperty("源端任务json")
    private String readerJson;

    @ApiModelProperty("目标端任务json")
