 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/mapper/JobDataTypeMappingMapper.java
 *
 *-------------------------------------------------------------------------
 */
@Mapper
@Repository
public interface JobDataTypeMappingMapper {

    int save(JobDataTypeMapping jobDataTypeMapping);

    int update(JobDataTypeMapping jobDataTypeMapping);

    List<JobDataTypeMapping> pageList(@Param("offset") int offset,
    ...
    JobDataTypeMapping getInfoById(@Param("id") int id);

    List<JobDataTypeMapping> getListBydatasource(@Param("datasource") String datasource);
