 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/mapper/JobLogMapper.java
 *
 *-------------------------------------------------------------------------
 */
@Mapper
public interface JobLogMapper {
    ...
    int batchDeleteLogByTaskInfo(@Param("jobDesc") String jobDesc,
    ...
    int batchDeleteLogByProjectId(@Param("projectId") Long projectId);
