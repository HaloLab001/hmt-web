 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/core/conf/JobConfig.java
 *
 *-------------------------------------------------------------------------
 */
@Component
...
@RefreshScope
@Configuration
public class JobConfig implements InitializingBean, DisposableBean {
  ...
  public void refreshConfig() {
    //请求路径
    String url = "http://localhost:8085/actuator/refresh";
