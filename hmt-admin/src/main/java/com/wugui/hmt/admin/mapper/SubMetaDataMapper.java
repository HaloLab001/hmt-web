...
import com.wugui.hmt.admin.tool.pojo.DataDashboardPojo;
...
@Mapper
@Repository
public interface SubMetaDataMapper {

    SubTemplatePojo getJobTemplateInfoById(Long id);

    List<MetaTypePojo> getMetaDashboardList(@Param("projectIds") Integer[] projectIds);

    DataDashboardPojo getDataDashboardInfo();
