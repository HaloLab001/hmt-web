package com.wugui.hmt.admin.mapper;
 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/mapper/JobInfoMapper.java
 *
 *-------------------------------------------------------------------------
 */
@Mapper
public interface JobInfoMapper {
    ...
    List<JobInfo> pageList(@Param("offset") int offset,
                           ...
                           @Param("tablesArray") String[] tablesArray,
                           @Param("isBigType") int isBigType);
    ...
    Integer batchStart(@Param("jobDesc") String jobDesc,
                       @Param("projectIds") Integer[] projectIds,
                       @Param("glueType") String glueType,
                       @Param("metaType") String metaType,
                       @Param("tablesArray") String[] tablesArray,
    ...
    List<JobInfo> scheduleJobQuery(@Param("pagesize") int pagesize);
    ...
    Integer batchStartFailTask(@Param("jobDesc") String jobDesc,
                               @Param("projectIds") Integer[] projectIds,
                               @Param("glueType") String glueType,
                               @Param("metaType") String metaType,
                               @Param("tablesArray") String[] tablesArray,
    ...
    int getJobInfoCountAwaitTotal(@Param("JobInfoDayFrom") Date JobInfoDayFrom,@Param("JobInfoDayTo") Date JobInfoDayTo);

    int getJobInfoCountRunningTotal();

    int batchDeleteTask(@Param("jobDesc") String jobDesc,
                        @Param("projectIds") Integer[] projectIds,
                        @Param("glueType") String glueType,
                        @Param("handleCode") String handleCode,
                        @Param("metaType") String metaType,
    ...
    Integer batchStopTask(@Param("jobDesc") String jobDesc,
                        @Param("projectIds") Integer[] projectIds,
                        @Param("glueType") String glueType,
                        @Param("metaType") String metaType,
                        @Param("tablesArray") String[] tablesArray,
    ...
    int batchDeleteTaskByProjectId(@Param("projectId") Long projectId);

    List<JobInfo> getPrepareSetList(@Param("jobGroup") int jobGroup,
                          @Param("triggerStatus") int triggerStatus,
                          @Param("jobDesc") String jobDesc,
                          @Param("glueType") String glueType,
                          @Param("projectIds") Integer[] projectIds,
    ...
    void batchSetDataWay(@Param("list") List<JobInfo> jobInfoList);

    int getJobCount(@Param("projectId") int projectId, 
                @Param("metaTypeId") String metaTypeId, 
                @Param("triggerStatus") int triggerStatus, 
                @Param("handleCodes") Integer[] handleCodes);

    Integer automationBatchStart(@Param("projectId") int projectId, 
                @Param("metaTypeId") String metaTypeId);

    List<JobInfo> getAutomationPrepareSetList(@Param("projectId") int projectId, 
                @Param("triggerStatus") int triggerStatus, 
                @Param("handleCode") String handleCode, 
                @Param("writerType") String writerType);

    void automationBatchSetDataWay(@Param("list") List<JobInfo> jobInfoList);
