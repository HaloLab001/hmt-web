 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/entity/JobDataTypeMapping.java
 *
 *-------------------------------------------------------------------------
 */
@Data
public class JobDataTypeMapping {
    ...
    @ApiModelProperty("源端数据类型")
    private String readerDataType;

    @ApiModelProperty("目标端数据类型")
    private String writerDataType;

    @ApiModelProperty("是否保留括号中的值: 0不保留 1保留")
    private int isRetainValue;
