 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/entity/JobDataContrastDetails.java
 *
 *-------------------------------------------------------------------------
 */
@Data
public class JobDataContrastDetails {
    ...
    @ApiModelProperty("源端对象名称")
    private String readerTable;

    @ApiModelProperty("目标端对象名称")
    private String writerTable;

    @ApiModelProperty("源端表记录数")
    private Long readerRecordRows;

    @ApiModelProperty("目标端表记录数")
    private Long writerRecordRows;

    @ApiModelProperty("对比结果是否一致: 0一致 1不一致")
    ...
    @ApiModelProperty("源端对象相关信息")
    private String readerInfo;

    @ApiModelProperty("目标端对象相关信息")
    private String writerInfo;

    @ApiModelProperty("类型映射相关信息")
