 ...
 *
 * IDENTIFICATION
 *	  hmt-admin/src/main/java/com/wugui/hmt/admin/config/SwaggerConfig.java
 *
 *-------------------------------------------------------------------------
 */
@Configuration
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
                .apis(RequestHandlerSelectors.basePackage("com.wugui.hmt.admin.controller")).paths(PathSelectors.any())
                .build();
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Hmt Web Api Docs").description("Hmt Web Api Docs")
                .build();
    }
