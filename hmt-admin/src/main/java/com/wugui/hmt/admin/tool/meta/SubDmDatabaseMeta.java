 ...
 *
 * IDENTIFICATION
 *    hmt-admin/src/main/java/com/wugui/hmt/admin/tool/meta/SubDmDatabaseMeta.java
 *
 *-----------------------------------------------
 */
public class SubDmDatabaseMeta {
    ...
    public static String getExistBigTypeTables(String schema, String tableName){
        ...
        sqlText = sqlText + "AND DATA_TYPE IN ('IMAGE','LONGVARBINARY','BLOB','CLOB','BFILE') ";
        return sqlText;
    }
