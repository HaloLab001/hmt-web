package com.wugui.hmt.core.executor.impl;
 ...
 *
 * IDENTIFICATION
 *    /hmt-core/src/main/java/com/wugui/datatx/core/executor/impl/JobSpringExecutor.java
 *
 *-----------------------------------------------
 */
            ...
            for (Object serviceBean : serviceBeanMap.values()) {
                if (serviceBean instanceof IJobHandler) {
                    ...
                    if (loadJobHandler(name) != null) {
                        throw new RuntimeException("hmt-web jobhandler[" + name + "] naming conflicts.");
                    }
