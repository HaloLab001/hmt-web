package com.wugui.hmt.core.executor;
...
import com.wugui.hmt.core.biz.impl.ExecutorBizImpl;
import com.wugui.hmt.core.handler.IJobHandler;
import com.wugui.hmt.core.log.JobFileAppender;
import com.wugui.hmt.core.thread.*;
import com.wugui.hmt.rpc.registry.ServiceRegistry;
import com.wugui.hmt.rpc.remoting.net.impl.netty_http.server.NettyHttpServer;
 ...
 *
 * IDENTIFICATION
 *    /hmt-core/src/main/java/com/wugui/datatx/core/executor/JobExecutor.java
 *
 *-----------------------------------------------
 */
public class JobExecutor {
            ...
            for (Map.Entry<Integer, JobThread> item : jobThreadRepository.entrySet()) {
                ...
                if (oldJobThread != null) {
                    try {
                        ...
                        logger.error(">>>>>>>>>>> hmt-web, JobThread destroy(join) error, jobId:{}", item.getKey(), e);
                    }
                }
            }
    ...
    public static IJobHandler registJobHandler(String name, IJobHandler jobHandler) {
        logger.info(">>>>>>>>>>> hmt-web register jobhandler success, name:{}, jobHandler:{}", name, jobHandler);
    ...
    public static JobThread registJobThread(int jobId, IJobHandler handler, String removeOldReason) {
        ...
        newJobThread.start();
        logger.info(">>>>>>>>>>> hmt-web regist JobThread success, jobId:{}, handler:{}", new Object[]{jobId, handler});
