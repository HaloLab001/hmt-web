package com.wugui.hmt.rpc.remoting.invoker.annotation;
 ...
 *
 * IDENTIFICATION
 *    /hmt-rpc/src/main/java/com/wugui/hmt/rpc/remoting/invoker/annotation/XxlRpcReference.java
 *
 *-----------------------------------------------
 */
