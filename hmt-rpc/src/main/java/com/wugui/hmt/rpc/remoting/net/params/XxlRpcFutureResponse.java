package com.wugui.hmt.rpc.remoting.net.params;
 ...
 *
 * IDENTIFICATION
 *    /hmt-rpc/src/main/java/com/wugui/hmt/rpc/remoting/net/params/XxlRpcFutureResponse.java
 *
 *-----------------------------------------------
 */
