package com.wugui.hmt.rpc.remoting.invoker.call;

/*-------------------------------------------------------------------------
 *
 * XxlRpcInvokeCallback.java
 * XxlRpcInvokeCallback类
 *
 ...
 *
 * IDENTIFICATION
 *    /hmt-rpc/src/main/java/com/wugui/hmt/rpc/remoting/invoker/call/XxlRpcInvokeCallback.java
 *
 *-----------------------------------------------
 */
